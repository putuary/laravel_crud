                    ...
                    <section>
                        <form method="post" action="{{ route('product.update', $product->id) }}" class="space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="image" name="image_url" type="text" class="mt-1 block w-full" :value="old('image_url', $product->image_url)" required autocomplete="image" />
                                <x-input-error class="mt-2" :messages="$errors->get('image_url')" />
                            </div>

                            <div>
                                <x-input-label for="price" :value="__('Price')" />
                                <x-text-input id="price" name="price" type="number" class="mt-1 block w-full" :value="old('price', $product->price)" required autocomplete="price" />
